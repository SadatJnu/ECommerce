app.controller('LISController', ['$scope', '$http', 'appMessage', '$filter', '$window', '$timeout', function LISController($scope, $http, appMessage, $filter, $window, $timeout) {
 ...
 $scope.miscTestNames = [];
    ...
    //$scope.Is_clickedSaveLisHematology = true;
    //$scope.Is_clickedHeamatologyPrint = false;
    //$scope.Is_clickedHeamatologyApproved = false;
    //$scope.Is_clickedSaveBioChemical = true;
    //$scope.Is_clickedPrintBiochemical = false;
    //$scope.Is_clickedApprovedBiochemical = false;
    //$scope.Is_clickedSaveHormone = true;
    //$scope.Is_clickedPrintHormone = false;
    //$scope.Is_clickedApprovedHormone = false;
    //$scope.Is_clickedSaveUrine = true;
    //$scope.Is_clickedPrintUrine = false;
    //$scope.Is_clickedApprovedUrine = false;
    //$scope.Is_clickedSaveStool = true;
    //$scope.Is_clickedPrintStool = false;
    //$scope.Is_clickedApprovedStool = false;
    //$scope.Is_clickedSaveLabReport = true;
    //$scope.Is_clickedPrintLabReport = false;
    //$scope.Is_clickedApprovedLabReport = false;
    //$scope.Is_clickedSaveMicrobiology = true;
    //$scope.Is_clickedPrintMicrobiology = false;
    //$scope.Is_clickedApprovedMicrobiology = false;
    ...
    //$scope.particulars4 = "SPE-Other01";
    //$scope.particulars5 = "SPE-Other02";

    //$scope.particulars9 = "SCE-Other01";
    //$scope.particulars10 = "SCE-Other02";
    //$scope.particulars11 = "SCE-Other03";

    //$scope.particulars290 = "SME-Other01";
    //$scope.particulars300 = "SME-Other02";
    $scope.particulars28 = "";
    $scope.particulars29 = "";
    $scope.particulars30 = "";
    ...
    $scope.SetUrineDropdownValue = function () {
        ...
        angular.forEach($scope.ValueSettingList, function (value, key) {
            ...
            else if (value.GroupName == "URINE" && value.DropdownName == "UME-Other04") {
    ...
    $scope.SaveStoolExamResult = function myFunction() {
        ...
        $scope.LISStoolExamResult.PthologistId = $scope.StoolConsultantt;
        ...
        $http({
            ...
            if (response.Success) {
                ...
                angular.forEach($scope.LISUrinExamResultDetails, function (item) {
                    ...
                    else if (item.Particulars == "UME-Other04") {
    ...
    $scope.OnChangeHematologyConsultant = function (val) {
        $scope.HematologyPathologistId = null;
        $scope.HematoPathologistSearch = $scope.HematologyPathologistId;
    }
...
if ($scope.MicroBios != null) {
    ...
    $scope.GetHormoneById = function () {
        ...
        $http({
            ...
            // for filtering TestGroup wise Results.

            //if ($scope.CompanyName == "ZamZam Hospital Limited") {
            //    angular.forEach(response.testParticulars, function (item) {
            //        var result = item.HormoneResult || null;
            //        if (item.DigTestInfoId == 194 && result == null) {
            //            item.TestGroupId = 4;
            //            $scope.Hormones.push(item);
            //        }
            //    });
            //}
            ...
            //$scope.ImmunoPathologist = response.pathologistId[0].ConsultantName;
            ...
            if ($scope.Hormones.length > 0) {
                ...
                angular.forEach($scope.Hormones, function (item) {
                    ...
                    if (result != null) {
                        ...
                        //$scope.ImmunologySpeciment = item.SpecimenName;
                        //$scope.ImmuSpecimen = item.SpecimenId; // taking value for specimen Update.
                        if (response.pathologistId.length > 0) {
                            $scope.ImmunooConsultantt = response.pathologistId[0].PathologistId;
                            $scope.ImmunoPathologistSearch = response.pathologistId[0].PathologistId;
                        ...
                        //$scope.ImmunoPathologist.ConsultantName = response.pathologistId[0].ConsultantName;
                        //$scope.ImmunoPathologist.Id = response.pathologistId[0].PathologistId;
                    }
                    else {
                        $scope.ImmunoPathologist = {
                            "ConsultantName": '',
            ...
            //$scope.ImmunologySpeciment = $scope.ImmunologySpeciment.Specimen;
    ...
    $scope.SaveLisHematology = function () {
        //if ($scope.HaematologySpecimenId == null || $scope.HaematologySpecimenId == 0) {
    ...
    $scope.SaveMicroBiology = function () {
        ...
        if ($scope.MicroBios != 0 || $scope.MicroBios == 0) {
            ...
            if ($scope.MicroBio.Id == 0 || $scope.MicroBio.Id > 0) {
                ...
                //$scope.dup = {};
                //$scope.duplicateValue = null;
                //angular.forEach($scope.MicroBios, function (item) {
                //    $scope.duplicateValue = tem.TestParticular;
                //    if ($scope.duplicateValue == item.TestParticular) {
                //        $scope.duplicateValue = null;
                //        $scope.dup.push(item);
                //    }
                //});
